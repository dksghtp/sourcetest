...
<!-- Favicon -->
<link href="/resources/step/img/favicon.ico" rel="icon">
...
<link href="/resources/step/lib/animate/animate.min.css" rel="stylesheet">
<link href="/resources/step/lib/owlcarousel/assets/owl.carousel.min.css"
	rel="stylesheet">

<!-- Customized Bootstrap Stylesheet -->
<link href="/resources/step/css/style.css" rel="stylesheet">
</head>
				...
				<div class="d-inline-flex align-items-center">
					<div class="btn-group">
						...
						<div class="dropdown-menu dropdown-menu-right">
							...
							<a href="/member/login">Sign in</a></button>
					...
					<div class="collapse navbar-collapse justify-content-between"
						...
						<div class="navbar-nav mr-auto py-0">
							<a href="/" class="nav-item nav-link active">Home</a> <a
								href="/shop/showShop" class="nav-item nav-link">Shop</a> <a
								href="/detail/shopDetail" class="nav-item nav-link">Shop
								Detail</a>
							<div class="nav-item dropdown">
								...
								<div class="dropdown-menu bg-primary rounded-0 border-0 m-0">
									<a href="/cart/myCartList" class="dropdown-item">Shopping
										Cart</a> <a href="/cart/checkOut" class="dropdown-item">Checkout</a>
								</div>
							</div>
