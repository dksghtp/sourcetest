            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                <div class="brand-logo">
                  <img src="/resources/admin/assets/images/logo-dark.svg">
                </div>
                ...
                <form class="pt-3">
                  ...
                  <div class="mt-3">
                    <a class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" href="/resources/admin/index.html">SIGN IN</a>
                  </div>
